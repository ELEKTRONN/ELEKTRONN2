...
config_file = os.path.expanduser('~/CNN_Training/3D/BIRD_MEMBRANE_v51_1099/Backup/config.py')
param_file  = os.path.expanduser('~/CNN_Training/3D/BIRD_MEMBRANE_v51_1099/BIRD_MEMBRANE_v51_1099-LAST.param')

probs, gm = legacy.create_cnn(config_file, 1, param_file=param_file, constant_weights=False)
#activations = []
...
def test_legacy():
    ...
    img = h5load(os.path.expanduser('~/devel/data/MPI/barrier_gt_4/cube0_barrier_raw.h5'))
